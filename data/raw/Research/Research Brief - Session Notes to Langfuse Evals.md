...
- [[Langfuse Tracing and Evaluation Direction]] records the implemented trace hierarchy, local smoke-test evidence, and the proposed first experiment.
- [[Wiki Pipeline and OKF Evolution]] establishes raw notes as source material and preserves provenance boundaries.
- [[Bounded Agentic Workflow Architecture]] establishes that review and approval remain bounded and human-controlled.
- [[Operational Lessons for Session Notes]] defines the privacy, configuration, and reproducibility rules for the corpus.
